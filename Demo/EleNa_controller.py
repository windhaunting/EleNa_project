...
class EleNa_Controller(object):
    ...
    def test_dijkstra(self):
        ...
        fig, ax = self.plot_two_routes(graph_orig, route2, route3, src_lat_long, destination_lat_long)
...
#     controller_obj.cal_route_dij(-72.531005, 42.406670, -72.531929, 42.325745, 'Max', 50)
